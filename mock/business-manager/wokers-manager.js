...
const BusinessManager = require('../../src/common/urls/business-manager');
const { WORKERS_MANAGER: { LIST_API, DETAIL_API, INSERT_API, UPDATE_API, REMOVE_API } } = BusinessManager
