  ...
  <div class="index-vue">
    ...
    <aside :class="asideClassName">
      ...
      <div class="logo-c">
        ...
        <img src="../assets/imgs/logo-20200719pm1427-zph.jpg" alt="logo" class="logo" />

        <span v-show="isShowAsideTitle" v-text="systemName"></span>
      </div>
      <!-- 菜单栏 -->
      <Menu
        class="menu"
...
<script>
import { resetTokenAndClearUser } from '@common/utils'
import { SYSTEM_NAME_ZHCN } from '@constant/system'

export default {
    name: 'index',
    data() {
        return {
            systemName: SYSTEM_NAME_ZHCN,
            // 用于储存页面路径
            paths: {},
            // 当前显示页面
            currentPage: '',
