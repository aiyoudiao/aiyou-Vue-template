 ...
 * @version: 1.0.0
 * @Author: aiyoudiao
 * @Date: 2020-08-19 02:29:33
 * @LastEditTime: 2020-08-19 05:25:17
 * @LastEditors: aiyoudiao
 * @FilePath: \aiyou-Vue-template\src\views\big-screen\index.vue
-->
<template>
  <div id="index">
    <dv-full-screen-container class="bg">
      ...
      <Row>
        <!-- 左边的资源数据 -->
        <Col span="12" class="v-contianer">
          <div class="source-data-title">资源数据</div>
          <div class="source-data-top">
            ...
            <div class="table">
              <dv-scroll-board :config="config" style="width:870px;min-height:calc(50 * 7px)" />
            </div>
          </div>
          <div class="source-data-bottom source-data-span">
            <div class="table-operator clearfix">
              <span class="left-f">设备统计</span>
              <span class="right-f">
                <Icon type="ios-search" />
            ...
            <div class="table">
              <dv-scroll-board :config="config3" style="width:870px;min-height:calc(50 * 6.23px)" />
            </div>
          </div>
        </Col>
        ...
        <!-- 右边的运营数据 -->
        <Col span="12" class="v-contianer">
          <div class="operation-data-title">运营数据</div>
          <div class="operation-data-top">
            <div class="table-operator clearfix">
            ...
            <div class="table">
              <dv-scroll-board :config="config2" style="width:870px;min-height:calc(50 * 6px)" />
            </div>
          </div>
          <div class="operation-data-bottom operation-data-span">
            <div class="table-operator clearfix">
            ...
            <div class="table">
              <dv-scroll-board :config="config4" style="width:870px;min-height:calc(50 * 6px)" />
            </div>
          </div>
        </Col>
      </Row>
      ...
      <Row>
        <!-- 网银线路 -->
        <Col span="24" class="line-container span-length">
          <div class="right-container">
            ...
            <div class="right-content-charts">
              <div class="content-charts">
                <ve-line :data="lineConfig.chartData"></ve-line>
              </div>
            </div>
          </div>
        </Col>
        ...
        <Col span="24" class="line-container span-length">
          <div class="right-container">
            ...
            <div class="right-content-charts">
              <div class="content-charts">
                <ve-line :data="lineConfig2.chartData" :settings="lineConfig2.chartSettings"></ve-line>
              </div>
            </div>
          </div>
        </Col>
        ...
        <Col span="24" class="line-container span-length">
          <div class="right-container">
            ...
            <div class="right-content-charts">
              <div class="content-charts">
                <ve-line :data="lineConfig3.chartData"></ve-line>
              </div>
            </div>
          </div>
        </Col>
        ...
        <Col span="24" class="line-container span-length">
          <div class="right-container">
            ...
            <div class="right-content-charts">
              <div class="content-charts">
                <ve-line :data="lineConfig8.chartData" :extend="lineConfig8.extend"></ve-line>
              </div>
            </div>
          </div>
        </Col>
        ...
        <Col span="24" class="line-container span-length">
          <div class="right-container">
            ...
            <div class="right-content-charts">
              <div class="content-charts">
                <ve-line :data="lineConfig4.chartData"></ve-line>
              </div>
            </div>
          </div>
        </Col>
        ...
        <Col span="24" class="line-container span-length">
          <div class="right-container">
            ...
            <div class="right-content-charts">
              <div class="content-charts">
                <ve-line :data="lineConfig5.chartData"></ve-line>
              </div>
            </div>
          </div>
        </Col>
        ...
        <Col span="24" class="line-container span-length">
          <div class="right-container">
            ...
            <div class="right-content-charts">
              <div class="content-charts">
                <ve-line :data="lineConfig6.chartData" :settings="lineConfig6.chartSettings"></ve-line>
              </div>
            </div>
          </div>
        </Col>
        ...
        <Col span="24" class="line-container span-length">
          <div class="right-container">
            ...
            <div class="right-content-charts">
              <div class="content-charts">
                <ve-line :data="lineConfig7.chartData"></ve-line>
              </div>
            </div>
          </div>
        </Col>
...
<script>
import { BIG_SCREEN, BIG_SCREEN_ZHCN } from '@constant/big-screen'

export default {
    name: 'BIG_SCREEN',
    data() {
        return {
            bigScreen: BIG_SCREEN_ZHCN,
            loading: true,
            /* 四张表格 */
            config: {
