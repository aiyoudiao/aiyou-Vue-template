  ...
  <div style="padding: 10px">
    <div style="background: #fff; border-radius: 8px; padding: 20px;">
      <Form :model="formItem" :label-width="80">
        <Row>
          <Col span="11">
            <FormItem label="角色名" :label-width="labelWidth">
              <Input v-model="formItem.roleName" placeholder="请输入角色名" clearable />
            </FormItem>
          </Col>
        ...
        <Row>
          <Col span="11">
            <FormItem label="角色状态" :label-width="labelWidth">
              <Select v-model="formItem.roleStatus" placeholder="选择角色状态">
...
export default {
    ...
    data() {
        return {
            title: SYSTEM_ROLE_MANAGER_ZHCN,
            permission: {
                insert: false,
                detail: false,
                update: false,
    ...
    beforeMount() {
        ...
        const currentPagePermissions = pagePermissions[SYSTEM_ROLE_MANAGER]
